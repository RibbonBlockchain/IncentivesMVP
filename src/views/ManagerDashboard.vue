<template>
  <div class="profile-page">
        ...
        <card shadow class="card-profile mt--300" no-body>
          <div class="px-4">
            ...
            <div class="text-center mt-5 mt--150">
              <h3>She Conquers</h3>
              <div class="h6">
                <i class="ni business_briefcase-24 mr-2"></i>Project Manager
              </div>
              <div class="h6 font-weight-300">
                <i class="ni location_pin mr-2"></i>South Africa
              </div>
              <hr>
            </div>
                            ...
                            <tr>
                              ...
                              <td>
                                <button
                                  ...
                                  type="button"
                                  @click="modals.practitioner = true"
                                >
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <button class="btn btn-icon btn-2 btn-warning" type="button">
                                      <span class="btn-inner--icon p-0 m-0">
                        ...
                        <div class="row p-3 m-3" style="width:800px">
                          <div class="col-4">
                            <base-button
                              type="secondary"
                              class="mr-4"
                              @click="advancedFunction"
                            >Transfer Management</base-button>
                          </div>
                          <div class="col-4">
                            <base-button
                              type="secondary"
                              class="mr-4"
                              @click="advancedFunction"
                            >Change Program Name</base-button>
                          </div>
                          <div class="col-4">
                            <base-button
                              type="warning"
    ...
    <modal :show.sync="modals.practitioner">
      ...
      <hr>
      <div class="row">
        <div class="col-5 text-center">Modify Allowance:</div>

        <div class="col-7 text-center">
          <button
            class="btn btn-icon btn-3 btn-primary btn-sm"
            type="button"
            @click="modifyAllowance(5000)"
          >
            <span class="btn-inner--icon">
      ...
      <div class="row pt-3">
        <div class="col-6">
          <base-slider :range="{min:0,max:100000}" v-model="programAllowance"/>
          <br>
        </div>
        <div class="col-6">
