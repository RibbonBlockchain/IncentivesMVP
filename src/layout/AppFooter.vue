        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; 2018
                        <a href="https://www.ribbonblockchain.com" target="_blank">Ribbon Blockchain</a>.
                    </div>
                </div>
                <div class="col-md-6">
                    <ul class="nav nav-footer justify-content-end">
                        <li class="nav-item">
                            <a href="https://www.ribbonblockchain.com" class="nav-link" target="_blank">Ribbon Blockchain</a>
                        </li>
                        <li class="nav-item">
                            <a href="https://github.com/ribbonblockchain" class="nav-link" target="_blank">Github</a>
                        </li>
